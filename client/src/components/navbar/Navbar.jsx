        ...
        <div className="navbar z-50 absolute bg-black/40 text-white font-extrabold text-xl">
            ...
            <div className="navbar-end gap-4">
                <div className="indicator">
                    ...
                    <a href="/dashboard" className="btn bg-transparent text-white indicator rounded-full"><FaShoppingCart className="text-2xl" /></a>
                </div>
                <div>
                    {
                        user ?
                            ...
                            :
                            <a href="/authenticate/signin" className="border border-amber-200 p-2 rounded-full hover:scale-95 active:scale-100 transition-transform">Sign In</a>
                    }
                </div>
            </div>
        </div>
